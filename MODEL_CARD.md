...
See the [GitHub repository](https://github.com/Davidsv/volley-ref-ai) for the complete VOLLEY-REF AI pipeline that combines both models for automatic IN/OUT detection.
...
@software{volley_ref_ai_2025,
  ...
  year = {2025},
  url = {https://github.com/Davidsv/volley-ref-ai}
}
```
